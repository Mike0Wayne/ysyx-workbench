...
#endif
                VL_FATAL_MT("vsrc/MUX.sv", 2, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void VMUX___024root___ctor_var_reset(VMUX___024root* vlSelf) {
    ...
    vlSelf->io_in1 = VL_RAND_RESET_I(3);
    vlSelf->io_in2 = VL_RAND_RESET_I(3);
    vlSelf->io_in3 = VL_RAND_RESET_I(3);
    vlSelf->io_in4 = VL_RAND_RESET_I(3);
    vlSelf->io_sel0 = VL_RAND_RESET_I(1);
